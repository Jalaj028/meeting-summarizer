  ...
  return (
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8">Meeting Summarizer (Assignment Jalaj Bhatt)</h1>
        ...
        {summary && (
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <textarea
              ...
              className="w-full p-4 border rounded-md h-[100px] focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm leading-relaxed resize-y"
            />
          </div>
        )}
